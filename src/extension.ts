...
export function activate(context: vscode.ExtensionContext) {
  ...
  const SentenceBar = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, -103) 
  const prevBtn = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, -104)
  const nextBtn = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, -105)
  prevBtn.text = '<'
